...
<body>
	...
	<table align="center" width="50%" height="50%">
			<tr>
				...
				<td align="center"><img src="img/b.png" class="zoom" height="70" width="70"></td>	
			...
			<tr>
				...
				<td align="center"><b><a href="rekening_akuntansi.php">Rekening Akuntansi</a></b></td>
				<td align="center"><b><a href="jurnal_transaksi.php">Jurnal Transaksi</a></b></td>	
			</tr>
	</table>
	<br><br><br><br>
	<table align="center" width="35%" height="35%">
			<tr>
				<td align="center"><img src="img/d.png" class="zoom" height="70" width="70"></td>
				<td align="center"><img src="img/e.png" class="zoom" height="70" width="70"></td>	
			</tr>
			<tr>
				<td align="center"><b><a href="buku_besar.php">Buku Besar</a></b></td>
				<td align="center"><b><a href="laporan.php">Laporan</a></b></td>
			</tr>
	</table>
